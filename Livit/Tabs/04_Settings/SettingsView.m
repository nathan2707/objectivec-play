...
{
	//if ((indexPath.section == 3) && (indexPath.row == 0)) return cellBlocked;
	//if ((indexPath.section == 3) && (indexPath.row == 1)) return cellPrivacy;
	if ((indexPath.section == 1) && (indexPath.row == 0)) return cellTerms;
    if ((indexPath.section == 0) && (indexPath.row == 0)) return cellProfile;
    if ((indexPath.section == 0) && (indexPath.row == 1)) return cellDiscovery;
    if ((indexPath.section == 0) && (indexPath.row == 2)) return cellInvites;
...

{
	...
	//if ((indexPath.section == 3) && (indexPath.row == 0)) [self actionBlocked];
	//if ((indexPath.section == 3) && (indexPath.row == 1)) [self actionPrivacy];
	if ((indexPath.section == 1) && (indexPath.row == 0)) [self actionTerms];
    if ((indexPath.section == 0) && (indexPath.row == 0)) [self actionProfile];
    if ((indexPath.section == 0) && (indexPath.row == 1)) [self actionDiscovery];
    if ((indexPath.section == 0) && (indexPath.row == 2)) [self actionInvites];
